...
<div class="relative bg-blueGray-200 mt-10 pt-8 pb-6">
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap text-left lg:text-left">
            <div class="w-full lg:w-6/12 px-4">
                {{-- <h4 class="text-3xl fonat-semibold text-blueGray-700">Investree</h4> --}}

                <img src="{{ asset('image/inv_logo.webp') }}" class="w-32">
                <h5 class="text-lg mt-2 mb-2 text-blueGray-600">
                    AIA Central Lantai 21, Jalan Jend. Sudirman Kav. 48A, RT05/RW04, Karet Semanggi, Jakarta Selatan,
                    Indonesia 12930
                </h5>
                <div class="mt-6 lg:mb-0 mb-6">
                    ...
                    <a
                        ...
                        <i class="fab fa-facebook-square"></i></a><button
                        class=" text-invesblue shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                        type="button">
