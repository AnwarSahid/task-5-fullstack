    ...
    <nav class=" sm:mx-auto sm:mt-10 pb-20">
        <div class="w-full sm:px-6">
            <div class=" grid grid-cols-12 ">
                ...
                {{-- <div class="col-span-2 mx-2 bg-white shadow-xl rounded-lg ">
                    <div class=" p-5">
                ...
                <div class="col-span-8 ml-10 h-full bg-white rounded-lg p-5 shadow-xl  ">
                    <form action="{{ route('create.new.post') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class=" mt-5 w-full">
                            ...
                            <button type="submit"
                                class="bg-invesblue mt-5 hover:bg-blue-700 text-white font-normal py-1 px-5 text-ms rounded-full focus:outline-none focus:shadow-outline flex flex-wrap items-center"><svg
